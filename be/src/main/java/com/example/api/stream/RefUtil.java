...
public class RefUtil {
    ...
    public static Consumer<String> sysOut = System.out::println;

    public static Function<Object, String> valueOf = String::valueOf;
    ...
    public static Function<String, Integer> str2int = Integer::parseInt;
    // pub lic Function<Integer, String> int2str = Integer::parseInt;
